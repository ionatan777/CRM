...
import { LayoutDashboard, Shield, Database, Search, Settings, LogOut } from 'lucide-react';
...
const DashboardLayout: React.FC = () => {
    ...
    const navItems = [
        ...
        { path: '/dashboard/pricing', label: 'Planes', icon: <Shield size={20} /> },
        { path: '/dashboard/backups', label: 'Mis Backups', icon: <Database size={20} /> },
        { path: '/dashboard/search', label: 'Buscar Mensajes', icon: <Search size={20} /> },
        ...
        <div className="flex h-screen bg-gray-50">
            ...
            <aside className="w-64 bg-white border-r border-gray-200 flex flex-col fixed h-full z-10">
                <div className="p-6 flex items-center space-x-2 border-b border-gray-100">
                    ...
                    <span className="text-xl font-bold text-gray-800 tracking-tight">WhatsBackup</span>
                </div>
